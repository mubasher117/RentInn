...
class MainPage extends React.Component {
  ...
  handleBack() {
    this.setState({
      ...
      progressValue: this.state.progressValue - 33.3334,
    });
  }
  handleNext() {
    this.setState({
      ...
      <MuiThemeProvider>
        <Grid className={classes.img}>
          <Grid container item style={{ marginLeft: "5%" }} lg={11}>
            ...
            <Grid container item lg={5} spacing={8} style={{ marginTop: "2%" }}>
              ...
              <Grid item>
                <Button
                  onClick={this.props.handleSeller}
                  style={{ color: "white" }}
                >
                  Rent Now
                </Button>
          ...
          <Grid item lg={11} style={{ marginLeft: "3%" }}>
            <div className={classes.root} style={{ float: "center" }}>
              ...
              <Typography
                ...
                variant="display1"
                align="center"
                style={{ color: "white", fontFamily: '"Consolas",sans-serif' }}
              >
              ...
              <center>
                <Button
                  variant="outlined"
                  onClick={this.props.handleSeller}
                  style={{ color: "white", backgroundColor: "#0284a8" }}
        ...
        <Grid container lg={11} style={{ marginTop: "3%", marginLeft: "8%" }}>
          ...
          >
            <Grid item>
              <img
                src={require("../Images/houseMa.gif")}
                style={{ color: "#0284a8", height: "150px" }}
              />{" "}
            </Grid>
            <Grid item>
          ...
          >
            <Grid item>
              {" "}
              <img
                src={require("../Images/bussiness.gif")}
                style={{ height: "120px" }}
              />{" "}
            </Grid>
            <Grid item style={{ marginTop: "5%" }}>
              {" "}
              <Typography>Bussiness Commercial</Typography>{" "}
            </Grid>
          </Grid>
          <Grid
            container
          ...
          >
            ...
            <Grid item>
              {" "}
              <Typography variant="subheading"> Apartments</Typography>
            </Grid>
          </Grid>
        </Grid>
